...
SECRET_KEY = 'django-insecure-w=34_+7n4#cjb2a5e&!z-zeduq#d)_$(7oy3@h%(^i3ez1sca3'
...
WSGI_APPLICATION = 'MISKCORP.wsgi.application'
...
EMAIL_FROM_ADDRESS = 'boss.ibragim.magomedov.04@inbox.ru'  # mandatory
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'boss.ibragim.magomedov.04@inbox.ru'
